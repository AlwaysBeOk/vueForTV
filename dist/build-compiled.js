...
var _freeze2 = _interopRequireDefault2(_freeze);
...
var _set3 = _interopRequireDefault2(_set2);
...
/***/function (module, exports, __webpack_require__) {
	...
	var _DateFilter = __webpack_require__(2);

	var _NumberFilter = __webpack_require__(3);

	var _ScalerService = __webpack_require__(4);

	var _CommentService = __webpack_require__(11);

	var _Geography = __webpack_require__(12);

	var _VoteService = __webpack_require__(13);
   ...
   */
	...
	var zanService = new _ScalerService.ScalerService('INTE1415093029127760');
	var commentService = null;
	var voteService = new _VoteService.VoteService('50970');
	...
	zanService.get(function (data) {
		...
		setInterval(function () {
			(0, _jquery2.default)('.zan_img').removeClass('tada');
			zanService.get(function (data) {
				activeData.zan = data.data.vc;
				(0, _jquery2.default)('.zan_img').addClass('tada');
			});
		}, 10000);
	});
		...
		methods: {
			...
			changePage: function changePage(pageNo) {
				if (pageNo == 1) {
					...
					activeData.stat = 3;
					commentService = new _CommentService.CommentService('ydyleditor1751401');
			...
			tagChange: function tagChange(value, index) {
				(0, _jquery2.default)('.btn li').removeClass('active');
				(0, _jquery2.default)('.btn  li').eq(index).addClass('active');
			...
			optChange: function optChange(index) {
				var li = (0, _jquery2.default)('.options  li').eq(index);
			...
			submitVote: function submitVote(voteid) {
				var items = (0, _jquery2.default)('.options  .active');
				console.log(items);
				var ids = [];
				for (var i = 0; i < items.length; i++) {
					var index = (0, _jquery2.default)('.options  li').index(items[i]);
					ids.push(activeData.vote.options[index].optionid);

					if (index + 1 == activeData.vote.options.length && activeData.other) {
						var cs = new _CommentService.CommentService('ydyleditor1751401_' + activeData.vote.questionid);
  ...
  */
   ...
   */
		...
		function def(obj, key, val, enumerable) {
			(0, _defineProperty4.default)(obj, key, {
				value: val,
   ...
   */
		...
		var _Set = undefined;
		/* istanbul ignore if */
		if (typeof _set3.default !== 'undefined' && isNative(_set3.default)) {
   ...
   */
		...
		function coerceProp(prop, value, vm) {
			...
			if (typeof coerce === 'function') {
				...
				'development' !== 'production' && warn('Invalid coerce for prop "' + prop.name + '": expected function, got ' + (typeof coerce === 'undefined' ? 'undefined' : (0, _typeof3.default)(coerce)) + '.', vm);
				return value;
			}
		}
    ...
    */
			...
			Vue.prototype._proxy = function (key) {
				if (!isReserved(key)) {
					...
					var self = this;
					(0, _defineProperty4.default)(self, key, {
						configurable: true,
						enumerable: true,
			...
			Vue.prototype._initComputed = function () {
				...
				if (computed) {
					for (var key in computed) {
						...
						(0, _defineProperty4.default)(this, key, def);
					}
				}
			};
...
/***/function (module, exports, __webpack_require__) {
	...
	_vue2.default.filter("roundDate", function (input) {
		input = input.replace('%', '');
...
/***/function (module, exports, __webpack_require__) {
	...
	var Geography = exports.Geography = function () {
		/**
   *ImgTextService 评论的接口服务,查看例子<a href='../es6/service/imgtext/eg/index.html'> ImgTextService的使用</a>
   * @requires jquery
   * @param zid {String} zid 评论的ID
   ...
   */
		function Geography() {
			(0, _classCallCheck3.default)(this, Geography);
		...
		(0, _createClass3.default)(Geography, [{
			key: "getGeoName",
			value: function getGeoName(_callback) {
				var that = this;
				$.getScript("http://ip.apps.cntv.cn/js/player.do", function () {
					var geoArr = area_info.split('|');
					if (geoArr[0] == 'CN') {
						_callback(that.city[geoArr[1]]);
					} else {
						_callback(that.country[geoArr[0]]);
					}
				});
			}
		}]);
...
/***/function (module, exports, __webpack_require__) {
   ...
   */
    ...
    */
			...
			key: 'postVoteId',
			value: function postVoteId(qid, oid) {
				_jquery2.default.ajax({
